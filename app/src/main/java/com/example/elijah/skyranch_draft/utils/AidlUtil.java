package com.example.elijah.skyranch_draft.utils;
...
public class AidlUtil {
    ...
    public ICallback generateCB(final com.sunmi.printerhelper.utils.PrinterCallback printerCallback){
    ...
    public void setDarkness(int index) {
        ...
        try {
            woyouService.sendRAWData(com.sunmi.printerhelper.utils.ESCUtil.setPrinterDarkness(k), null);
     ...
     * @return list
     */
    public List<String> getPrinterInfo(com.sunmi.printerhelper.utils.PrinterCallback printerCallback) {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return null;
        }
...
//                woyouService.printText("\n纵向排列\n", null);
     ...
     * 打印表格
     */
    public void printTable(LinkedList<com.sunmi.printerhelper.bean.TableItem> list) {
        if (woyouService == null) {
            Toast.makeText(context,R.string.toast_2,Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            for (com.sunmi.printerhelper.bean.TableItem tableItem : list) {
